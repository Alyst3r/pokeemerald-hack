...
// Aleist3r: copying this here to not mess with too many includes :P
...
// GEN 9 ITEMS
    ...
    [ITEM_OLD_STATUE] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 30,
        .iconPic = gItemIcon_OldStatue,
        .iconPalette = gItemIconPalette_OldStatue,
    },
};
